...
```{r}
# Production time
y <- c(175, 189, 344, 88, 114, 338, 271, 173, 284, 277, 337, 58, 146,
       277, 123, 227, 63, 337, 146, 68)

# Number of units in the order
x <- c(195, 215, 243, 162, 185, 231, 234, 166, 253, 196, 220, 168, 207,
       225, 169, 215, 147, 230, 208, 172)
...
inputPanel(
  ...
  sliderInput("beta0", label = "Intercept:",
              min = -500, max = 300,
              value = reg$coefficients[1] + 600, step = 5),
...
renderPlot({
  plot(y ~ x, main =
         paste("RSS:", round(sum((input$beta0 + input$beta1 * x - y)^2), 1)),
       pch = 16, xlim = c(100, 300), ylim = c(0, 400))
